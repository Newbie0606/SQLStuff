...
--EXEC #SpToTempTable N'EXEC dbo.spForecastSummary F00000137818;', N'#DOut'
EXEC #SpToTempTable N'EXEC dbo.spForecastSummary F00000143598', N'#DOut'

SELECT * FROM #DOut FOR JSON AUTO

-- EXEC sp_describe_first_result_set N'EXEC dbo.spForecastSummary F00000137818;';
